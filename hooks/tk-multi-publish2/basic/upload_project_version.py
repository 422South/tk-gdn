...
class GDNUploadProjectPlugin(HookBaseClass):
    """
    ...
    def settings(self):
        ...
        base_settings = super(GDNUploadProjectPlugin, self).settings or {}
    ...
    def accept(self, settings, item):
        ...
        self.logger.info("GDN 'Upload Project Version' plugin accepted.")
